...
User.destroy_all
u1 = User.create!(username: 'Albert', password: 'password', email: 'albert@hotmail.com', city_id: 1000, host_status: "true", description: desc, background: bgnd, topics: tpcs, tagline: tgln, img_url: u1_img_url)
u2 = User.create!(username: 'Brienne', password: 'password', email: 'brienne@hotmail.com', city_id: 7, host_status: "true", description: desc, background: bgnd, topics: tpcs, tagline: tgln, img_url: u2_img_url)
u3 = User.create!(username: 'Cory', password: 'password', email: 'cory@hotmail.com', city_id: 3, host_status: "true", description: desc, background: bgnd, topics: tpcs, tagline: tgln, img_url: u3_img_url)
u4 = User.create!(username: 'David', password: 'password', email: 'david@hotmail.com', city_id: 4, host_status: "true", description: desc, background: bgnd, topics: tpcs, tagline: tgln, img_url: u4_img_url)
u5 = User.create!(username: 'Guest', password: 'password', email: 'guest@hotmail.com', city_id: 5, host_status: "true", description: desc, background: bgnd, topics: tpcs, tagline: tgln)
u6 = User.create!(username: 'Glenn', password: 'password', email: 'glenn@hotmail.com', city_id: 7)
u7 = User.create!(username: 'Kyle', password: 'password', email: 'kyle@hotmail.com', city_id: 1000, host_status: "true", description: desc, background: bgnd, topics: tpcs, tagline: tgln)
u8 = User.create!(username: 'Rob', password: 'password', email: 'rob@hotmail.com', city_id: 2, host_status: "true", description: desc, background: bgnd, topics: tpcs, tagline: tgln, img_url: u8_img_url)
u9 = User.create!(username: 'Daria', password: 'password', email: 'daria@hotmail.com', city_id: 3, host_status: "true", description: desc, background: bgnd, topics: tpcs, tagline: tgln, img_url: u9_img_url)
u10 = User.create!(username: 'Bill', password: 'password', email: 'bill@hotmail.com', city_id: 4, host_status: "true", description: desc, background: bgnd, topics: tpcs, tagline: tgln, img_url: u10_img_url)
u11 = User.create!(username: 'Ashley', password: 'password', email: 'ashley@hotmail.com', city_id: 5, host_status: "true", description: desc, background: bgnd, topics: tpcs, tagline: tgln)
u12 = User.create!(username: 'Anna', password: 'password', email: 'anna@hotmail.com', city_id: 1)
u13 = User.create!(username: 'Tom', password: 'password', email: 'tom@hotmail.com')
u14 = User.create!(username: 'Liz', password: 'password', email: 'liz@hotmail.com', city_id: 3)
u15 = User.create!(username: 'Henry', password: 'password', email: 'henry@hotmail.com')
u16 = User.create!(username: 'Chris', password: 'password', email: 'chris@hotmail.com', city_id: 5)
u17 = User.create!(username: 'Alex', password: 'password', email: 'alex@hotmail.com')
